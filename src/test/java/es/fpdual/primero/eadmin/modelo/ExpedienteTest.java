...
//		for(Documento documentoActual: documentos) {
//			if (documentoActual.getTipoDocumento().equals(TipoDocumento.DOCUMENTO_CONTABLE)) {
//			System.out.println(documentoActual);
//			}
//		}
		...
		forEach(documentoActual 
				-> System.out.println(documentoActual)); //Devuelve
//		Es similar a:
		documentos.stream().
			filter(this::esDocumentoContable).
			forEach(System.out::println);//Es mejor
...
//		assertEquals(Integer.parseInt ("6"),resultado.get(0).intValue()); 
	...
	public void deberiaDevolverTrueSiDosObjetosExpedientesSonIguales () {
		...
		final Expediente expediente1 = 
				new Expediente (1,null, null, null, null, null);
		final Expediente expediente2 = 
				new Expediente (1,null, null, null, null, null);
	...
	public void deberiaCalcularHashCodeDeExpediente () {
		final Expediente expediente = 
				new Expediente (100,null, null, null, null, null);
...
//	final Documento doc1 = new Documento (1, "uno", usuario, fecha, TipoDocumento.DOCUMENTO_CONTABLE);
//	final Documento doc2= new Documento (2, "dos", usuario, fecha, TipoDocumento.DOCUMENTO_CONTABLE);
//	final Documento doc3= new Documento (3, "otro", usuario, fecha, TipoDocumento.DOCUMENTO_NOMINA);
//	}
